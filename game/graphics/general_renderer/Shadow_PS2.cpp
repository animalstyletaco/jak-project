...
void BaseShadowRenderer::run_mscal10_vu2c() {
  // ENTER_10:
...
void BaseShadowRenderer::handle_bal52() {
...
void BaseShadowRenderer::handle_jalr_to_end_block(u16 val, u32& first_flag, u32& second_flag) {
  switch (val) {
    case 724:
...
void BaseShadowRenderer::run_mscal_vu2c(u16 imm) {
  u32 cf = 0, sf0, sf1;
  bool bc;
  switch (imm) {
    case 2:
