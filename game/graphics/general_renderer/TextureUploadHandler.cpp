...
BaseTextureUploadHandler::BaseTextureUploadHandler(const std::string& name, int my_id)
...
void BaseTextureUploadHandler::render(DmaFollower& dma,
  ...
  while (dma.current_tag_offset() != render_state->next_bucket) {
    ...
    if (dma_tag.qwc == (128 / 16)) {
      ...
      eye_renderer_handle_eye_dma2(dma, render_state, prof);
      uploads.clear();
    }
...
void BaseTextureUploadHandler::draw_debug_window() {
