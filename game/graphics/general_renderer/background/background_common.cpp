...
void background_common::make_all_visible_multidraws(std::pair<int, int>* draw_ptrs_out,
                                 u32* counts_out,
...
u32 background_common::make_all_visible_multidraws(std::pair<int, int>* draw_ptrs_out,
                                u32* counts_out,
                                void** index_offsets_out,
...
u32 background_common::make_all_visible_index_list(std::pair<int, int>* group_out,
                                u32* idx_out,
                                const std::vector<tfrag3::ShrubDraw>& draws,
                                const u32* idx_in) {
...
u32 background_common::make_multidraws_from_vis_string(std::pair<int, int>* draw_ptrs_out,
                                    u32* counts_out,
                                    void** index_offsets_out,
                                    const std::vector<tfrag3::StripDraw>& draws,
...
u32 background_common::make_index_list_from_vis_string(std::pair<int, int>* group_out,
                                    u32* idx_out,
                                    const std::vector<tfrag3::StripDraw>& draws,
                                    const std::vector<u8>& vis_data,
                                    const u32* idx_in,
