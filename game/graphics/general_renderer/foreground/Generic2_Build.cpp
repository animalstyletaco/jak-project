...
/*!
 * Main function to set up BaseGeneric2:: draw lists.
 * This function figures out which vertices belong to which draw settings.
 */
void BaseGeneric2::setup_draws(bool enable_at, bool default_fog) {
 ...
 */
void BaseGeneric2::determine_draw_modes(bool enable_at, bool default_fog) {
 ...
 */
void BaseGeneric2::link_adgifs_back_to_frags() {
 ...
 */
void BaseGeneric2::draws_to_buckets() {
 ...
 */
void BaseGeneric2::process_matrices() {
 ...
 */
void BaseGeneric2::final_vertex_update() {
  for (u32 i = 0; i < m_next_free_adgif; i++) {
    auto& ad = m_adgifs[i];
 ...
 */
void BaseGeneric2::build_index_buffer() {
