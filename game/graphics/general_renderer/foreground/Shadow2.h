...
struct Shadow2VertexPushConstantData {
  math::Vector4f perspectives[4];
...
class BaseShadow2 : public BaseBucketRenderer {
 ...
 protected:
  ...
  virtual void draw_buffers(BaseSharedRenderState* render_state,
                            ScopedProfilerNode& prof,
                            const FrameConstants& constants) = 0;
