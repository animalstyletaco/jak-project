...
class BaseOceanMid {
 ...
 protected:
  ...
  virtual void run_call73_vu2c() = 0;
  virtual void run_call107_vu2c() = 0;
  virtual void run_call275_vu2c() = 0;
  void xgkick(u16 addr);

  void run_L26_vu2c();
  virtual void run_L32_vu2c() = 0;
  virtual void run_L38_vu2c() = 0;
  void run_L43_vu2c();
  void run_L45_vu2c();
...
class BaseOceanMidJak1 : public virtual BaseOceanMid {
  void prepare_for_run(DmaFollower& dma, BaseSharedRenderState* render_state) override;
  void run_call73_vu2c() override;
  void run_call107_vu2c() override;
  void run_call275_vu2c() override;

  void run_L32_vu2c() override;
  void run_L38_vu2c() override;
};

class BaseOceanMidJak2 : public virtual BaseOceanMid {
 protected:
  void prepare_for_run(DmaFollower& dma, BaseSharedRenderState* render_state) override;
  void run_call73_vu2c() override;
  void run_call107_vu2c() override;
