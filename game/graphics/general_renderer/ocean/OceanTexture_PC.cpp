...
void BaseOceanTexture::run_L5_PC() {
  // clang-format off
  u16 loop_idx;
  Vf res0;
  Vf res1;
...
void BaseOceanTexture::xgkick_PC(Vf* src) {
...
void BaseOceanTexture::setup_renderer() {
  m_pc.vtx_idx = 0;
}

void BaseOceanTexture::init_pc() {
  int i = 0;
...
void BaseOceanTexture::destroy_pc() {}
