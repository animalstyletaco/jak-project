...
class UniformBuffer {
 public:
  ...
  virtual void SetUniform1ui(const char* section_name, uint32_t value, uint32_t flags = 0);
  virtual void SetUniform1i(const char* section_name, int32_t value, uint32_t flags = 0);
  virtual void SetUniform1f(const char* section_name, float value, uint32_t flags = 0);
  ...
  virtual void SetUniformMathVector3f(const char* section_name, math::Vector3f& value, uint32_t flags = 0);

  virtual void SetUniformMathVector4f(const char* section_name, math::Vector4f& value, uint32_t flags = 0);
