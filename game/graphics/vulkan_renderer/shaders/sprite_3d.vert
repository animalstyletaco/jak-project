...
void main() {
    ...
    if (rendermode == 3) { // 3D sprites
        ...
        scales_vf01.z = min(max(scales_vf01.z, ubo.min_scale), ubo.max_scale);
        scales_vf01.w = min(max(scales_vf01.z, ubo.min_scale), ubo.max_scale);
        ...
        scales_vf01.w = max(scales_vf01.z, ubo.min_scale);
