...
void GraphicsPipelineLayout::createGraphicsPipeline(Shader& shader,
  ...
  shaderStages[0].module = shader.GetVertexShader();
  ...
  shaderStages[1].module = shader.GetFragmentShader();
