...
int InitHeapAndSymbol() {
  ...
  Ptr<u32> symbol_table =
      kmalloc(kglobalheap, jak3::SYM_TABLE_MEM_SIZE, KMALLOC_MEMSET, "symbol-table").cast<u32>();
  ...
  *KernelDebug = 0;
  ...
  // in real jak3, the -1 occurs in the GoalProtoHandler. But let's just do it here to make
  // things consistent.
