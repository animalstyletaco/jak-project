...
// printable keys
//Added extra 8 buttons to represent mouse buttons
...
constexpr const char* const LUT256To356[]{"ESCAPE",
                                          "ENTER",
                                          "TAB",
                                          "BACKSPACE",
                                          "INSERT",
...
constexpr const char* KeyCodeToString(KeyCode keycode) noexcept {
  ...
  if (keycode >= 256 && keycode <= 356)
    [[likely]] { return LUT256To356[keycode - 256]; }
