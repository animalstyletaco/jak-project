...
// '#define ImTextureID ImU64'. See imgui_impl_vulkan.cpp file for details.
...
struct ImGui_ImplVulkan_InitInfo {
  ...
  VkSampleCountFlagBits
      MSAASamples;  // >= VK_SAMPLE_COUNT_1_BIT (0 -> default to VK_SAMPLE_COUNT_1_BIT)
...
// Helpers
IMGUI_IMPL_API void ImGui_ImplVulkanH_CreateOrResizeWindow(VkInstance instance,
